...
<?php
	...
	$html .="<tr>";
		...
		$html .= "<th><a href='?searching=".$searching."&sort=username&direction=".$direction."'>username</a></th>";
		$html .= "<th><a href='?searching=".$searching."&sort=o_course&direction=".$direction."'>o_course</a></th>";
